  ...
  return (
    ...
    <div style={{ fontFamily: font, maxWidth: 1100 }}>
      ...
      <p style={{ fontSize: 14, color: G.textSec, lineHeight: 1.7, maxWidth: 760, marginTop: 28 }}>
        Paste your content in the box above for an instant overview, then open any tool for the full breakdown — keyword density, long-tail phrases, search intent, competitor gaps and more across {TOOLS.filter((t) => !t.noindex).length} dimensions. Everything runs in your browser; no signup and nothing leaves your device.
      </p>
    </div>
    </>
  );
