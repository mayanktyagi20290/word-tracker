...
function CompTab({ analysis }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      {!result && <GCard><div style={{ textAlign: "center", padding: 24, color: G.textHint, fontSize: 13 }}>Add at least one competitor's content above to see gap analysis</div></GCard>}
