...
function analyzeEEAT(text){
  ...
  const author   = /\b(written by|author|by\s+[A-Z][a-z]+\s+[A-Z][a-z]+|about the author|editor|reviewed by)\b/.test(text) || /\bin my (experience|opinion|testing)\b/i.test(text);
